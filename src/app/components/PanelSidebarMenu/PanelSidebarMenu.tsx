        ...
        {props.routes.map((item: models.route, itemKey: number) => (
            ...
            >
              ...
              <div className="panel-sidebar-menu__items__single__items">
                {item.items.map((subItem: models.routeInner, subItemKey: number) => (
                    <div
                    ...
                    >
                      <Link
                        ...
                        className={`panel-sidebar-menu__items__single__items__single__link ${isActive(`${item.route}${subItem.route}`) &&
